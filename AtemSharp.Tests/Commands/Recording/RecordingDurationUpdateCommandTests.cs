...
internal class RecordingDurationUpdateCommandTests : DeserializedCommandTestBase<RecordingDurationUpdateCommand, RecordingDurationUpdateCommandTests.CommandData>
{
    ...
    internal override void CompareCommandProperties(RecordingDurationUpdateCommand actualCommand, CommandData expectedData, TestUtilities.CommandTests.TestCaseData<CommandData> testCase)
    {
