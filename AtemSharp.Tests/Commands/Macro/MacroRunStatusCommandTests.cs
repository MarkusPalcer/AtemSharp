...
public class MacroRunStatusCommandTests : SerializedCommandTestBase<MacroRunStatusCommand>
{
    protected override MacroRunStatusCommand CreateCommand(IStateHolder state, JObject? creationParameters) => new();
