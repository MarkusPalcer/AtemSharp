...
{
    private static readonly IReadOnlyDictionary<VideoMode, ushort> FramesByVideoMode = new Dictionary<VideoMode, ushort>
    {
    ...
    [ExcludeFromCodeCoverage(Justification = "The test would just repeat the code")]
    public static ushort FramesPerSecond(this VideoMode videoMode)
        => FramesByVideoMode[videoMode];
