...
[Generator]
public class DeserializedCommandGenerator : CodeGeneratorBase
{
    protected override bool ClassFilter(INamedTypeSymbol classSymbol, ClassDeclarationSyntax classDecl) =>
        classSymbol.Interfaces.Any(i => i.Name == "IDeserializedCommand")
     && classDecl.Modifiers.Any(SyntaxKind.PartialKeyword)
     && classSymbol.GetMembers().OfType<IFieldSymbol>().Any();

    protected override void ProcessClass(SourceProductionContext spc, INamedTypeSymbol symbol, ClassDeclarationSyntax classDecl)
    {
