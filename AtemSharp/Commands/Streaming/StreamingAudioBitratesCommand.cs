...
{
    [SerializedField(0)] private uint _lowBitrate = state.Streaming.AudioBitrates.Low;

    [SerializedField(4)] private uint _highBitrate = state.Streaming.AudioBitrates.High;
}
