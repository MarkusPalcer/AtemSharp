...
public class SuperSourceBorderUpdateCommandTests : DeserializedCommandTestBase<SuperSourceBorderUpdateCommand, SuperSourceBorderUpdateCommandTests.CommandData>
{
    ...
    protected override void CompareCommandProperties(SuperSourceBorderUpdateCommand actualCommand, CommandData expectedData, TestCaseData testCase)
    {
