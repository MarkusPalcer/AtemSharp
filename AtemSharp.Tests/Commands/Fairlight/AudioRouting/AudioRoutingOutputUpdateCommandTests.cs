...
public class AudioRoutingOutputUpdateCommandTests : DeserializedCommandTestBase<AudioRoutingOutputUpdateCommand, AudioRoutingOutputUpdateCommandTests.CommandData>
{
    ...
    protected override void CompareCommandProperties(AudioRoutingOutputUpdateCommand actualCommand, CommandData expectedData, TestCaseData testCase)
    {
