...
public class DownstreamKeyStateCommandTests : DeserializedCommandTestBase<DownstreamKeyStateCommand, DownstreamKeyStateCommandTests.CommandData>
{
    ...
    protected override void CompareCommandProperties(DownstreamKeyStateCommand actualCommand, CommandData expectedData, TestCaseData testCase)
    {
        Assert.Multiple(() =>
        {
