...
public static class AtemUtil
{
    ...
    public static double UInt16BEToDecibel(ushort input)
    {
    ...
    public static ushort DecibelToUInt16BE(double input)
    {
    ...
    public static double IntToBalance(short input)
    {
        // -100000 = -50, 0x0000 = 0, 0x2710 = +50
        return Math.Round(input / 200.0);
    }
    ...
    public static short BalanceToInt(double input)
    {
