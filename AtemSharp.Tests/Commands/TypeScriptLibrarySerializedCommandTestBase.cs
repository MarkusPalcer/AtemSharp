...
public abstract class TypeScriptLibrarySerializedCommandTestBase<TCommand, TTestData>
    where TCommand : SerializedCommand
    where TTestData : TypeScriptLibrarySerializedCommandTestBase<TCommand, TTestData>.CommandDataBase, new()
{
    /// <summary>
