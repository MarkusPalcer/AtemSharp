...
public partial class SuperSourceBoxParametersUpdateCommandV8 : IDeserializedCommand
{
    ...
    [DeserializedField(8)] [ScalingFactor(100)] [SerializedType(typeof(short))]
    private double _y;

    [DeserializedField(10)] [ScalingFactor(1000)] [SerializedType(typeof(ushort))]
    ...
    [DeserializedField(20)] [ScalingFactor(1000)] [SerializedType(typeof(short))]
