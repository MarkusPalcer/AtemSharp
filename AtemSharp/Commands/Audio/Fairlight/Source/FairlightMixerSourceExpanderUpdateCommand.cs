...
[Command("AIXP")]
internal partial class FairlightMixerSourceExpanderUpdateCommand : IDeserializedCommand
{
    ...
    [DeserializedField(17)] private bool _gateEnabled;

    [DeserializedField(16)] private bool _expanderEnabled;
