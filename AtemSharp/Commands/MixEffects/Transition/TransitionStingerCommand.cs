...
public partial class TransitionStingerCommand(MixEffect mixEffect) : SerializedCommand
{
    ...
    /// </summary>
    [SerializedField(3,0)]
    private byte _source = mixEffect.TransitionSettings.Stinger.Source;

    /// <summary>
    /// Whether the key is pre-multiplied
    /// </summary>
    [SerializedField(4,1)]
    private bool _preMultipliedKey = mixEffect.TransitionSettings.Stinger.PreMultipliedKey;
    ...
    private bool _invert = mixEffect.TransitionSettings.Stinger.Invert;

    /// <summary>
    /// Preroll value for the stinger transition
    /// </summary>
    [SerializedField(12,5)]
    private ushort _preroll = mixEffect.TransitionSettings.Stinger.Preroll;

    /// <summary>
    /// Clip duration for the stinger transition
    /// </summary>
    [SerializedField(14,6)]
    private ushort _clipDuration = mixEffect.TransitionSettings.Stinger.ClipDuration;

    /// <summary>
    /// Trigger point for the stinger transition
    /// </summary>
    [SerializedField(16,7)]
    private ushort _triggerPoint = mixEffect.TransitionSettings.Stinger.TriggerPoint;

    /// <summary>
    /// Mix rate for the stinger transition
    /// </summary>
    [SerializedField(18,8)]
    private ushort _mixRate = mixEffect.TransitionSettings.Stinger.MixRate;
